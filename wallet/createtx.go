...
func makeInputSource(eligible []wtxmgr.Credit) txauthor.InputSource {
	...
	return func(target partutil.Amount) (partutil.Amount, []*wire.TxIn, [][]byte, error) {
...
func (s secretSource) GetKey(addr partutil.Address) (*btcec.PrivateKey, bool, error) {
...
func (s secretSource) GetScript(addr partutil.Address) ([]byte, error) {
	ma, err := s.Address(addr)
	if err != nil {
		return nil, err
	}
...
func (w *Wallet) txToOutputs(outputs []*wire.TxOut, account uint32, minconf int32) (*txauthor.AuthoredTx, error) {
	...
	changeSource := func() ([]byte, error) {
		...
		var changeAddr partutil.Address
