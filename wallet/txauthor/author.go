...
// InputSourceError.
type InputSource func(target partutil.Amount) (total partutil.Amount, inputs []*wire.TxIn, scripts [][]byte, err error)
...
func NewUnsignedTransaction(outputs []*wire.TxOut, relayFeePerKb partutil.Amount,
